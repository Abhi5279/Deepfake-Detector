...
function UploadImage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axios.post("http://localhost:4000/predict-image", formData, {
  ...
  return (
    <div className="font-roboto min-h-screen flex items-center justify-center bg-black p-6 font-sans">
      <div className="bg-white bg-opacity-5 backdrop-blur-lg border border-white border-opacity-10 rounded-3xl shadow-2xl p-8 md:p-12 w-full max-w-xl text-white">
